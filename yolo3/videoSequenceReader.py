...
def getSequenceNames(validationSetOnly=True):
    ...
    datasetDir = './dataset-objectDetection/sequenceSets/' # folder with images for which there are labels
...
def getDataFrames(seqName='seq01', numFrames=5):
    datasetDir = './dataset-objectDetection/sequenceSets/' # folder with images for which there are labels
    ...
    for frameFile in frameFiles:
        ...
        frame, _, _ = preprocess.prep_image(framePath, inp_dim=416)
